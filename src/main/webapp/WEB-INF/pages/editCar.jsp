...
<t:pageTemplate pageTitle="Edit Car">
    ...
    <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPath}/EditCar">
            <div class="row">
              ...
              <input type="text" class="form-control" id="license_plate" name="license_plate" placeholder="SB01ABC" required value="${car.licensePlate}"/>
              ...
              <input type="text" class="form-control" id="parking_spot" name="parking_spot" placeholder="Spot 1" required value="${car.parkingSpot}"/>
              <div class="invalid-feedback">
